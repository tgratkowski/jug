...
public class Example2Main {
	...
	public static void main(String[] args) {
		...
		ProcessInstance processInstance = ksession.startProcess("org.jug.zgora.sample4");

		Example2Main.printSingleEndLOG(ksession, taskService, processInstance);
	...
	protected static void printEndLOG(KieSession ksession, TaskService taskService, ProcessInstance proc) {
		System.out.println("\n");
		Example2Main.printSingleEndLOG(ksession, taskService, proc);
		...
		for (ProcessInstance procIn : ksession.getProcessInstances()) {
			Example2Main.printSingleEndLOG(ksession, taskService, procIn);
		}
		System.out.println("#########################################################################################################\n");
	}
